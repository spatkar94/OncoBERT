...
OncoBERT is a language model designed to learn contextual representations cancer somatic mutations from large-scale clinical sequencing data. These learned vector representations enable:
